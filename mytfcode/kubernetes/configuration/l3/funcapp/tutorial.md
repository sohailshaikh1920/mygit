Step by step guide on how to deploy an Azure Function with Terraform. No prior experience with TF is required.
...
Here's how the app service configuration will change for different environments
