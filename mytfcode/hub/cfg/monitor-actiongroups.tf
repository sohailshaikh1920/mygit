...
resource "azurerm_monitor_action_group" "budget" {
  ...
  email_receiver {
    ...
    email_address           = var.budget_incident_email
...
resource "azurerm_monitor_action_group" "ops-critical" {
  ...
  email_receiver {
    name                    = "IncidentsMontelGroup"
    email_address           = var.ops-critical_incident_email
    use_common_alert_schema = true
  }
}
...
resource "azurerm_monitor_action_group" "ops-error" {
  ...
  email_receiver {
    name                    = "IncidentsMontelGroup"
    email_address           = var.ops-error_incident_email
    use_common_alert_schema = true
  }
}
...
resource "azurerm_monitor_action_group" "ops-warning" {
  ...
  email_receiver {
    name                    = "IncidentsMontelGroup"
    email_address           = var.ops-warning_incident_email
    use_common_alert_schema = true
  }
}
...
resource "azurerm_monitor_action_group" "ops-info" {
  ...
  email_receiver {
    name                    = "IncidentsMontelGroup"
    email_address           = var.ops-info_incident_email
    use_common_alert_schema = true
  }
}
